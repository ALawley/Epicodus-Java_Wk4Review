...
--
-- Name: concerts; Type: TABLE; Schema: public; Owner: Guest; Tablespace: 
--
...
ALTER TABLE concerts OWNER TO "Guest";

--
-- Name: concerts_id_seq; Type: SEQUENCE; Schema: public; Owner: Guest
--
...
ALTER TABLE concerts_id_seq OWNER TO "Guest";

--
-- Name: concerts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Guest
--
...
--
-- Data for Name: concerts; Type: TABLE DATA; Schema: public; Owner: Guest
--
...
--
-- Name: concerts_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Guest
--
...
--
-- Name: concerts_pkey; Type: CONSTRAINT; Schema: public; Owner: Guest; Tablespace: 
--
